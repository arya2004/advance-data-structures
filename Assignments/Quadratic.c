...
//     int count = 0;
//     init(arr, &count, TS);
//     insert(arr, 42, TS, &count);
//     insert(arr, 16, TS, &count);
//     insert(arr, 91, TS, &count);
//     insert(arr, 33, TS, &count);
//     insert(arr, 18, TS, &count);
//     insert(arr, 27, TS, &count);
//     insert(arr, 36, TS, &count);
// //   /   insert(arr, 62, TS, &count);
//     display(arr, TS);
